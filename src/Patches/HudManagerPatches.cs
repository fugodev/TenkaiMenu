...
public static class HudManager_Update
{
	public static void Postfix(HudManager __instance)
    {
    	__instance.ShadowQuad.gameObject.SetActive(!TenkaiESP.IsFullbrightActive()); // Fullbright
		...
		TenkaiCheats.UseVentCheat(__instance);
		TenkaiESP.ZoomOut(__instance);
		TenkaiESP.FreecamCheat();
